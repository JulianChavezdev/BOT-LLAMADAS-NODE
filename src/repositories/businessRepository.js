...
function mergeBusiness(dbBusiness) {
    ...
    return {
        ...defaultBusiness,
        ...source,
        description: source.description || defaultBusiness.description,
        address: source.address || defaultBusiness.address,
        phone: source.phone || defaultBusiness.phone,
        openingHours: source.openingHours || defaultBusiness.openingHours,
        faq: source.faq || defaultBusiness.faq,
        voice: {
